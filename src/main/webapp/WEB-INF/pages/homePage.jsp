...
<body>
	<div>
		<div class="header" style="height:60px;">
	 		<form action="${ctx}/goods/search" method="post">
        		...
        		<input class="btn" type="submit" value="搜索" name="searchButton" id="searchButton" style="width:80px;position:relative;left:180px;top:-40px"/>
			</form>
				<%
	...
	<div style="vertical-align:middle;position:relative;top:0px;margin:30px;"> 
		...
		<div align="center" style="margin:20px;">
               <a href="${pageContext.request.contextPath}/page/jumpToHomePage">首页</a>
               <c:if test="${pageModel.pageNo>1&&pageModel.datas!=null}"><a href="${pageContext.request.contextPath}/page/jumpToHomePage?pageNo=${pageModel.pageNo-1}">上一页</a></c:if>
               <c:if test="${pageModel.pageNo<pageModel.totalpage&&pageModel.datas!=null}"><a href="${pageContext.request.contextPath}/page/jumpToHomePage?pageNo=${pageModel.pageNo+1}">下一页</a></c:if>
               <c:if test="${pageModel.totalpage!=0}">
               		<a href="${pageContext.request.contextPath}/page/jumpToHomePage?pageNo=${pageModel.totalpage}">
             			尾页
             		</a>
             	</c:if>
	...
	<div class="foot">	
		<p style="font-size:15px;text-align:center;color:#666666;border:0px;">趣分期系统</p>
	</div>
</body>
</html>
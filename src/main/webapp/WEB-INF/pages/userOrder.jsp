...
<div id="payArea" style="width:65%;text-align:right;margin-left:auto;margin-right:auto;">
		<a href="${ctx}/user/levelUp?userID=${userID}">
			<input class="btn3" id="recieveButton" type="button" value="提高额度" style="position:relative;right:20px"/>
		</a>
		<a href="${ctx}/user/rejectLevelUp?userID=${userID}">
